...
export const services: Service[] = [
  {
    ...
    imageAlt: 'Professional consultation discussion between practitioner and patient',
    icon: Activity,
    benefits: [
  ...
  },
  {
    ...
    duration: '30 min',
    price: 'R650',
    image: '/uploads/full-body-massage.png',
    imageAlt: 'Professional massage therapy treatment session',
    icon: Zap,
    benefits: [
      'Progress evaluation',
